...
const MODULES = ['evolutions.js', 'abilities.js', 'dungeon.js', 'descent.js', 'ascent.js', 'rules.js', 'weapons.js', 'monsters.js'];
...
export function loadGame() {
  ...
  parts.push(`globalThis.__game = { Evolutions, Abilities, Dungeon, Descent, Ascent, Rules, Weapons, Monsters };`);
  const sandbox = {
