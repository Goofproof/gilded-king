...
const MODULES = ['evolutions.js', 'abilities.js', 'dungeon.js', 'descent.js', 'ascent.js', 'paradiso.js', 'rules.js', 'weapons.js', 'monsters.js', 'encounters.js', 'trinkets.js', 'player.js'];
...
export function loadGame() {
  ...
  parts.push(`globalThis.__game = { Evolutions, Abilities, Dungeon, Descent, Ascent, Paradiso, Rules, Weapons, Monsters, Encounters, Trinkets, PlayerDef };`);
  const sandbox = {
