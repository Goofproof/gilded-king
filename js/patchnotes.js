...
const PatchNotes = (() => {
  ...
  const NOTES = [
    ...
    },
    {
      ...
      sha: '37deb75',
      items: [
        'Deep floors announce their character (Siege, Hunt, Bulwark, Frost) when you arrive, so the variety is clear.',
      ],
    },
    {
    ...
    },
    {
      ...
      sha: '8ce140a',
      items: [
        'Your hero gently breathes and bobs when standing still instead of freezing in place.',
      ],
    },
    {
    ...
    },
    {
      ...
      sha: '7d9a686',
      items: [
        'Mobile: tapping to play now fills your whole phone screen instead of a tiny window.',
      ],
    },
    {
    ...
    },
    {
      ...
      sha: '5c6331a',
      items: [
        'Death tales now name what slew you and read like a bard\'s song, not a stiff epic.',
      ],
    },
    {
    ...
    },
    {
      ...
      sha: 'df5b3b8',
      items: [
        'Co-op: each hero now has their own colored ring and matching name so you can tell everyone apart.',
      ],
    },
    {
