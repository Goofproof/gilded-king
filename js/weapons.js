...
const Weapons = (() => {
  ...
  const MYTHIC_WEAPONS = [
    ...
    { id: 'kusanagi',    name: 'Kusanagi',         archetype: 'light', model: 'shortsword',color: '#8fe0c0', dmg: 29, enchants: ['sharpness', 'sweeping', 'momentum'],        flavor: 'The grass-cutting sword. It turns the wind itself against them.' },
    ...
    { id: 'artemis',     name: "Artemis' Bow",     archetype: 'bow',   model: 'longbow',   color: '#dfe8f0', dmg: 35, enchants: ['piercing', 'power', 'multishot'],            flavor: 'The huntress never announces the shot. You are simply already struck.' },
    ...
    { id: 'circe',       name: "Circe's Wand",     archetype: 'wand',  model: 'rod',       color: '#a06bff', dmg: 27, magicReq: 3, enchants: ['chain', 'venom', 'multishot'],     flavor: "She turned a whole crew to swine with one wave of it." },
